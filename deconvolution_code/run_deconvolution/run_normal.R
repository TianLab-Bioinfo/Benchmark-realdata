...
results_path <- "~/DEC_benmark/TCGA/processed/benchmark_syq/new/COAD/GEO/normal/"
...
seurat_ER = readRDS.lbzip2('~/DEC_benmark/TCGA/processed/COAD/scRNA/COAD_normal.rdsFS',n.cores = 100)
...
ER_bulk <- readRDS("/home/syq/DEC_benmark/TCGA/processed/COAD/Bulk/GSE39582/exp_normal.rds")
